...
#define BLYNK_TEMPLATE_ID "TMPL6yNqdFGFh"
#define BLYNK_TEMPLATE_NAME "DHT"
#define BLYNK_AUTH_TOKEN "6sSYAz-BAVvg-vk0Dpo0NzLySlxOsRJy"
...
#define BUTTON_PIN 26   // pushbutton, one side to GPIO5, other to GND
